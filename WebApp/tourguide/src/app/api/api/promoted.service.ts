...
import {
    PromotedServiceInterface
} from './promoted.serviceInterface';
...
export class PromotedService implements PromotedServiceInterface {
    ...
    public getPromotedPOIS(longitudeMin: number, latitudeMin: number, longitudeMax: number, latitudeMax: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        if (longitudeMin !== undefined && longitudeMin !== null) {
          queryParameters = this.addToHttpParams(queryParameters,
            <any>longitudeMin, 'longitudeMin');
        }
        if (latitudeMin !== undefined && latitudeMin !== null) {
          queryParameters = this.addToHttpParams(queryParameters,
            <any>latitudeMin, 'latitudeMin');
        }
        if (longitudeMax !== undefined && longitudeMax !== null) {
          queryParameters = this.addToHttpParams(queryParameters,
            <any>longitudeMax, 'longitudeMax');
        }
        if (latitudeMax !== undefined && latitudeMax !== null) {
          queryParameters = this.addToHttpParams(queryParameters,
            <any>latitudeMax, 'latitudeMax');
        }
