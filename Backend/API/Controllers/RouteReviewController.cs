...
namespace API.Controllers
{
  ...
  public class RouteReviewController : Controller
  {
    ...
    public RouteReviewController(IRouteReviewService routeService)
    {
      _routeReviewService = routeService ?? throw new ArgumentNullException(nameof(routeService), "Context was null!");
    }
