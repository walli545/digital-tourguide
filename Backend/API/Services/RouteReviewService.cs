...
namespace API.Services
{
  public class RouteReviewService : IRouteReviewService
  {
    ...
    /// <param name="routeService">Serviceclass for the poi's</param>
    public RouteReviewService(ILogger<RouteReviewService> logger, MariaDbContext dbContext, IRouteService routeService)
    {
